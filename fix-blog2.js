...
const newStories = `  const stories = [
    ...
    },
    {
      ...
      author: 'Japa Genie Team',
      location: 'Nigeria to Europe to Canada',
    ...
    },
    {
      ...
      title: 'The Island Nobody Talks About: How Cape Verde Is Becoming Africas Launchpad to Europe',
      ...
      author: 'Japa Genie Team',
      location: 'Nigeria to Cape Verde to EU',
    ...
    },
    {
      ...
      title: 'From Heartbreak to Toronto: Amaras Visa Rejection Reversal',
      excerpt: 'Three rejections could not stop this Ivorian software engineer from reaching Canada.',
      author: 'Amara Kone',
      location: 'Cote dIvoire to Toronto Canada',
    ...
    },
    {
      ...
      outcome: '65,000 pounds salary',
      hook: 'Everyone said teachers cannot get UK Global Talent visas. I proved them wrong.',
      readTime: '6 min read'
    }
  ];`;

// Find and replace the stories array using regex
content = content.replace(/const stories = \[[\s\S]*?\];/, newStories);
