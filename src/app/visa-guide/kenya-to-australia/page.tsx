...
export const metadata: Metadata = {
  title: 'Kenya to Australia Visa Guide 2026 — Requirements, Costs and Timeline | Japa Genie',
  description: 'Complete Kenya to Australia immigration guide 2026. Visa requirements, proof of funds, processing times and step-by-step guide for Africans.',
  openGraph: { title: 'Kenya to Australia Visa Guide 2026 | Japa Genie', description: 'Complete Kenya to Australia immigration guide 2026.', url: 'https://japagenie.com/visa-guide/kenya-to-australia', siteName: 'Japa Genie', type: 'article' },
  alternates: { canonical: 'https://japagenie.com/visa-guide/kenya-to-australia' },
};
    ...
    <section className="py-16 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Kenya to Australia Visa Guide 2026</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Everything you need to move from Kenya to Australia in 2026 — visa routes, proof of funds, real costs, and step-by-step guidance for African applicants.</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-4">Get Your Personalised Kenya to Australia Roadmap</h2>
