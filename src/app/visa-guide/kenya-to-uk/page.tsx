...
export const metadata: Metadata = {
  title: 'Kenya to United Kingdom Visa Guide 2025 — Requirements, Costs & Timeline | Japa Genie',
  description: 'Complete Kenya to United Kingdom visa guide for 2025. Visa requirements, proof of funds, processing times, hidden costs and step-by-step application guide.',
  openGraph: {
    title: 'Kenya to United Kingdom Visa Guide 2025 | Japa Genie',
    description: 'Complete Kenya to United Kingdom visa guide for 2025.',
    url: 'https://japagenie.com/visa-guide/kenya-to-uk',
    siteName: 'Japa Genie',
    type: 'article',
  },
  alternates: {
    canonical: 'https://japagenie.com/visa-guide/kenya-to-uk',
  }
};
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Kenya to United Kingdom Visa Guide 2025
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Everything you need to know about moving from Kenya to United Kingdom — visa requirements, proof of funds, costs, and timeline.
          </p>
        </div>
