...
export const metadata: Metadata = {
  title: 'Nigeria to Portugal Visa Guide 2025 — Requirements, Costs & Timeline | Japa Genie',
  description: 'Complete Nigeria to Portugal visa guide for 2025. Visa requirements, proof of funds, processing times, hidden costs and step-by-step application guide.',
  openGraph: {
    title: 'Nigeria to Portugal Visa Guide 2025 | Japa Genie',
    description: 'Complete Nigeria to Portugal visa guide for 2025.',
    url: 'https://japagenie.com/visa-guide/nigeria-to-portugal',
    siteName: 'Japa Genie',
    type: 'article',
  },
  alternates: {
    canonical: 'https://japagenie.com/visa-guide/nigeria-to-portugal',
  }
};
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Nigeria to Portugal Visa Guide 2025
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Everything you need to know about moving from Nigeria to Portugal — visa requirements, proof of funds, costs, and timeline.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">D7 Passive Income</div>
