...
export const metadata: Metadata = {
  title: 'Nigeria to Australia Visa Guide 2026 — Requirements, Costs and Timeline | Japa Genie',
  description: 'Complete Nigeria to Australia immigration guide 2026. Visa requirements, proof of funds, processing times and step-by-step guide for Africans.',
  openGraph: { title: 'Nigeria to Australia Visa Guide 2026 | Japa Genie', description: 'Complete Nigeria to Australia immigration guide 2026.', url: 'https://japagenie.com/visa-guide/nigeria-to-australia', siteName: 'Japa Genie', type: 'article' },
  alternates: { canonical: 'https://japagenie.com/visa-guide/nigeria-to-australia' },
};
    ...
    <section className="py-16 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Nigeria to Australia Visa Guide 2026</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Everything you need to move from Nigeria to Australia in 2026 — visa routes, proof of funds, real costs, and step-by-step guidance for African applicants.</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white rounded-xl p-5 shadow-sm border text-center"><DollarSign className="w-7 h-7 text-blue-600 mx-auto mb-2" /><div className="text-xl font-bold">AUD $5,000-$8,000</div><div className="text-xs text-gray-500 mt-1">Est. Total Cost</div></div>
          <div className="bg-white rounded-xl p-5 shadow-sm border text-center"><Clock className="w-7 h-7 text-blue-600 mx-auto mb-2" /><div className="text-xl font-bold">8-18 months</div><div className="text-xs text-gray-500 mt-1">Processing Time</div></div>
          <div className="bg-white rounded-xl p-5 shadow-sm border text-center"><CheckCircle className="w-7 h-7 text-green-600 mx-auto mb-2" /><div className="text-xl font-bold">Skilled Migration</div><div className="text-xs text-gray-500 mt-1">Top Visa Route</div></div>
        </div>
        <div className="bg-white rounded-xl p-8 shadow-sm border mb-8">
          <h2 className="text-2xl font-bold mb-6">Core Requirements</h2>
          <div className="space-y-3">
            {['Valid passport — minimum 6 months validity, at least 2 blank pages','Proof of funds — AUD $5,000+ recommended for settlement. No fixed govt threshold','Language — IELTS 6.0 each band minimum. Target 7.0+ for competitive points score','Educational qualifications and professional certifications (apostilled/attested)','Police clearance certificate from your home country police authority','Medical examination clearance from an approved health provider','Completed visa application with all supporting documents'].map((req, i) => (
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-4">Get Your Personalised Nigeria to Australia Roadmap</h2>
