...
export const metadata: Metadata = {
  title: 'Nigeria to Cyprus Visa Guide 2026 — Requirements, Costs and Timeline | Japa Genie',
  description: 'Complete Nigeria to Cyprus immigration guide 2026. Visa requirements, proof of funds, processing times and step-by-step guide for Africans.',
  openGraph: { title: 'Nigeria to Cyprus Visa Guide 2026 | Japa Genie', description: 'Complete Nigeria to Cyprus immigration guide 2026.', url: 'https://japagenie.com/visa-guide/nigeria-to-cyprus', siteName: 'Japa Genie', type: 'article' },
  alternates: { canonical: 'https://japagenie.com/visa-guide/nigeria-to-cyprus' },
};
    ...
    <section className="py-16 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Nigeria to Cyprus Visa Guide 2026</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Everything you need to move from Nigeria to Cyprus in 2026 — visa routes, proof of funds, real costs, and step-by-step guidance for African applicants.</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white rounded-xl p-5 shadow-sm border text-center"><DollarSign className="w-7 h-7 text-blue-600 mx-auto mb-2" /><div className="text-xl font-bold">€2,000-€4,000</div><div className="text-xs text-gray-500 mt-1">Est. Total Cost</div></div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-4">Get Your Personalised Nigeria to Cyprus Roadmap</h2>
