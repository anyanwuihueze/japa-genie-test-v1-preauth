...
export default function UserChat() {
  ...
  // 🚨 ADD THIS: READ KYC DATA FROM STORAGE
  useEffect(() => {
    ...
    if (kycData) {
      ...
      // 🚀 FEED TO CHAT CONTEXT
      if (parsed.country && parsed.destination) {
        const welcomeContext = `User from ${parsed.country} wants to go to ${parsed.destination}`;
        console.log('🎯 Chat context updated:', welcomeContext);
      }
    }
  }, []);
