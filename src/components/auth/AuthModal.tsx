...
import { X, Mail, Loader2, Sparkles, CheckCircle, KeyRound } from 'lucide-react'
...
export default function AuthModal({ isOpen, onClose, redirectPath }: AuthModalProps) {
  ...
  // Google auth kept alive but hidden
            ...
            <>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <input
                  ...
                  required
                  maxLength={6}
                  className="w-full text-center text-3xl tracking-widest py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                {error && <p className="text-sm text-red-600 text-center">{error}</p>}
              ...
              <p className="text-xs text-gray-400 text-center mt-4">Didn't get it? Check spam.</p>
