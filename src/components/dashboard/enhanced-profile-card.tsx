...
export function EnhancedProfileCard({ userProfile }: EnhancedProfileCardProps) {
  ...
  const getInspirationalMessage = () => {
    if (completion < 50) return 'Your global journey starts with a single step!';
    if (userProfile?.destination_country)
      return `Your ${userProfile.destination_country} dream is within reach!`;
  ...
  return (
    <Card className="bg-gradient-to-br from-blue-50 via-purple-50 to-blue-100 border-blue-200 relative overflow-hidden group hover:shadow-lg transition-all duration-300 group-hover:scale-[1.02] transition-transform">
      ...
      <CardContent className="relative z-10 space-y-3">
        ...
        {/* Name & Age */}
        <div className="flex justify-between items-center bg-white/80 rounded-lg p-2">
