...
Subcommand to host the decK file operations.
...
* [deck file kong2kic](/deck/{{page.kong_version}}/reference/deck_file_kong2kic)	 - Convert Kong configuration files to Kong Ingress Controller (KIC) manifests
* [deck file kong2tf](/deck/{{page.kong_version}}/reference/deck_file_kong2tf)	 - Convert Kong configuration files to Terraform resources
...
* [deck file namespace](/deck/{{page.kong_version}}/reference/deck_file_namespace)	 - Apply a namespace to routes in a decK file by path or hostname
